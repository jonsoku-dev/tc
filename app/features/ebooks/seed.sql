...
VALUES
  ...
  (uuid_generate_v4(), (SELECT ebook_id FROM ebooks WHERE title = '웹 개발 마스터하기' ORDER BY created_at DESC LIMIT 1), 1, 1, 'HTML 소개', 'text', '{"content": "HTML은 웹 페이지의 구조를 정의하는 마크업 언어입니다. 웹 페이지의 기본 골격을 형성하며, 텍스트, 이미지, 링크 등의 요소를 배치하는 방법을 지정합니다.", "style": {"fontSize": "16px", "lineHeight": "1.6"}}'),
  
  (uuid_generate_v4(), (SELECT ebook_id FROM ebooks WHERE title = '웹 개발 마스터하기' ORDER BY created_at DESC LIMIT 1), 2, 2, 'HTML 기본 구조', 'code', '{"language": "html", "code": "<!DOCTYPE html>\\n<html>\\n<head>\\n  <title>제목</title>\\n</head>\\n<body>\\n  <h1>안녕하세요!</h1>\\n</body>\\n</html>", "caption": "기본 HTML 문서 구조"}'),
  
  (uuid_generate_v4(), (SELECT ebook_id FROM ebooks WHERE title = '웹 개발 마스터하기' ORDER BY created_at DESC LIMIT 1), 3, 3, '반응형 웹 디자인', 'image', '{"url": "https://images.unsplash.com/photo-1547658719-da2b51169166?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1064&q=80", "alt": "반응형 웹 디자인", "caption": "다양한 디바이스에서 최적화된 사용자 경험을 제공하는 반응형 웹 디자인", "width": 1064, "height": 700}'),
  
  (uuid_generate_v4(), (SELECT ebook_id FROM ebooks WHERE title = '데이터 과학 입문' ORDER BY created_at DESC LIMIT 1), 1, 1, '데이터 과학 개요', 'text', '{"content": "데이터 과학은 데이터로부터 가치 있는 통찰력을 얻는 분야입니다. 이는 통계학, 컴퓨터 과학, 도메인 지식을 결합하여 데이터에서 의미 있는 패턴을 발견하고 의사 결정에 활용합니다.", "style": {"fontSize": "16px", "lineHeight": "1.6"}}'),
  
  (uuid_generate_v4(), (SELECT ebook_id FROM ebooks WHERE title = '데이터 과학 입문' ORDER BY created_at DESC LIMIT 1), 2, 2, '데이터 시각화 예제', 'image', '{"url": "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80", "alt": "데이터 시각화 예제", "caption": "데이터 시각화 차트", "width": 1170, "height": 780}'),
  
  (uuid_generate_v4(), (SELECT ebook_id FROM ebooks WHERE title = '데이터 과학 입문' ORDER BY created_at DESC LIMIT 1), 3, 3, '머신러닝 기초', 'mixed', '{"blocks": [{"type": "text", "content": "머신러닝은 컴퓨터가 데이터로부터 학습하여 예측이나 결정을 내릴 수 있게 하는 기술입니다."}, {"type": "image", "url": "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1965&q=80", "alt": "머신러닝 개념", "caption": "머신러닝 알고리즘의 학습 과정", "width": 1965, "height": 1310}]}');
